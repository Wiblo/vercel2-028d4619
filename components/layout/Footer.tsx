...
import { businessInfo, getGoogleMapsUrl, getPhoneLink, getEmailLink } from "@/lib/data/business-info"
import { getSocialLinksWithUrls, getQuickLinksWithBooking } from "@/lib/data/navigation"
...
export function Footer() {
  ...
  return (
    <footer className="bg-background pb-18 pt-2 md:pb-4">
      <div className="mx-auto max-w-7xl px-2 xl:max-w-none 2xl:px-48">
        <div className="w-full overflow-hidden rounded-4xl bg-secondary/10 px-6 py-8 md:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-4">
              <div className="flex items-end space-x-2">
                ...
                <div className="min-w-0 pb-0.5">
                  <h3 className="font-signature text-lg font-semibold leading-tight text-foreground sm:text-2xl">
                    {businessInfo.name}
                  </h3>
                  <p className="font-heading mt-0.5 break-words text-[8px] font-semibold uppercase tracking-[0.1em] text-muted-foreground sm:text-[10px] sm:tracking-[0.25em]">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="font-heading mb-4 font-semibold text-foreground">
                Quick Links
              </h4>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  >
                    ...
                    {businessInfo.address.area && <p>{businessInfo.address.area}</p>}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm text-muted-foreground">
                    <a href={getPhoneLink(businessInfo.phone)} className="hover:text-primary">
                      {businessInfo.phone}
                    </a>
                    {businessInfo.phoneSecondary && (
                      <>
                        <span className="mx-2">|</span>
                        <a href={getPhoneLink(businessInfo.phoneSecondary)} className="hover:text-primary">
                          {businessInfo.phoneSecondary}
                        </a>
                      </>
                    )}
            ...
            <div>
              ...
              {businessInfo.bookingUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex w-full items-center justify-center rounded-lg bg-primary px-4 py-3 text-sm font-medium text-primary-foreground transition-all hover:bg-primary-hover"
                >
          ...
          <div className="grid grow grid-cols-1 gap-x-4 gap-y-6 md:grid-cols-[auto_1fr_auto] md:gap-x-8 md:gap-y-10 lg:gap-x-12 xl:grid-cols-[auto_1fr_auto]">
            ...
            <div className="flex md:items-center md:justify-center">
              <p className="text-xs font-medium text-muted-foreground">
                © {businessInfo.name} {currentYear} All Rights Reserved
              </p>
            </div>
